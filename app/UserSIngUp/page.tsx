    ...
    <div>
        ...
        <form className='LoginForm'>
            <div className='w-60 h-16 mx-auto my-5 flex flex-col justify-around items-center'>
                ...
                <input className='w-72 h-7 rounded-lg text-center font-semibold bg-red-400 text-white' type="email"></input>
            </div>
            ...
            <button className="w-56 h-10 shadow-md rounded-md text-white font-semibold text-xl cursor-pointer bg-red-400 hover:w-64 duration-200">Sing up</button>
        </form>
