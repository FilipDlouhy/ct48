...
function page() {
    ...
    <div>
        ...
        <div className='BlogPageReporter flex flex-col items-center p-5'>
            <input placeholder='Url for Img' src={img} className=" w-64 rounded-md  bg-red-400 text-center text-white font-semibold mb-4 cursor-pointer" onChange={(e)=>{
                setImg(e.target.value)
            }}  type="text"></input>    
              <img className='h-2/5 w-11/12'></img>
            <textarea className='w-1/2 text-center h-8 resize-none my-5 text-2xl font-bold'>GIGACHADUS AUUGSTUS</textarea>
