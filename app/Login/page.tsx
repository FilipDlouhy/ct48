  ...
  return (
    <div>
        <div className='w-full h-11 mt-8 flex items-center justify-between '>
             ...
             <button className='my-6 w-52 h-8 text-white bg-red-400 text-lg font-semibold    rounded-lg hover:w-64 duration-300 cursor-pointer' > Sing in new Reporter</button>
        </div>
    
        <h1 className='text-center mx-auto my-8 text-2xl text-emerald-50 font-bold'>Log in to Post Blogs</h1>    
